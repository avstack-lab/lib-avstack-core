...
import numpy as np
from avstack.geometry import bbox, Transform, Translation, Vector, Rotation, StandardCoordinates, NominalTransform
...
def get_object(seed):
    ...
    box_obj = bbox.Box3D([2,2,5,[0,0,0],0], NominalTransform)  # box in local coordinates
    ...
    obj.set(0, pos_obj, box_obj, vel_obj, acc_obj, rot_obj, ang_obj, T_reference=NominalTransform)
    return obj
