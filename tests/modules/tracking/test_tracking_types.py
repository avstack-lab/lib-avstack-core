...
def get_ego():
    ...
    box = bbox.Box3D([1,2,4,[0,0,0],0], StandardCoordinates)  # box in local coordinates
...
def get_object(ego):
    ...
    box_obj = bbox.Box3D([2,2,5,[0,0,0],0], StandardCoordinates)  # box in local coordinates
