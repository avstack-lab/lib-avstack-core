...
from avstack.sensors import LidarData, ImageData
from avstack.geometry import Box3D, NominalOriginStandard, NominalOriginCamera, Translation, Rotation, Transform
from avstack.geometry import Origin, q_cam_to_stan, q_stan_to_cam
...
P_cam = np.array([[7.215377000000e+02, 0.000000000000e+00, 6.095593000000e+02, 4.485728000000e+01],
                  [0.000000000000e+00, 7.21537000000e+02,  1.728540000000e+02, 2.163791000000e-01],
...
def get_lane_lines():
    ...
    pts_left = [Translation([x,y,0], origin=NominalOriginStandard) for x, y in pt_pairs_left]
    lane_left = detections.LaneLineInSpace(pts_left)
    pts_right = [Translation([x,y,0], origin=NominalOriginStandard) for x, y in pt_pairs_right]
...
def get_object_global(seed):
    ...
    obj.set(0, pos_obj, box_obj, vel_obj, acc_obj, rot_obj, ang_obj, origin=CameraOrigin)
    return obj
